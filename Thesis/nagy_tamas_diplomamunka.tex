...
\begin{figure}[H]
	...
	\caption{A (\subref{fig:gabor}) Gabor függvény  elõállítása az (\subref{fig:gaussian}) Gauss függvénybõl és a (\subref{fig:sinusoid}) szinusz hullámból}
...
értesíti a távoli szegmenst tartalmazó szervizt a módosításról. Mivel a szerviz közvetlenül nem
...
%képesek kiszámítani. 
%\subsubsection{Kiegyensúlyozott hisztogram-küszöbölés} %TODO Write about thematic classification?
...
%TODO Write about this in a subsection instead of a subsubsection?
