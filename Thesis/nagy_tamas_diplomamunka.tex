...
lehetõségeinek megismerésére, melyre a késõbbiekben építkezni lehetett.

\subsubsection{Spektrális Invertálás}
Az \textit{invertálás} talán a legegyszerûbb spektrális mûvelet, melynek során az egyes 
intenzitásértékeket "fordítjuk meg" a felvétel minden pixelére. Ezt úgy érhetjük el, hogy a
radiometriai felbontás maximálisan felvehetõ értékébõl vonjuk ki az intenzitásértékeket.

%TODO Recompose and add math figure
...
- az input tetszõleges módon particionálható, és a mûveletek elvégezhetõek 
egy szimpla \textit{Map} fázisban. 

%TODO Consider writing here something about Orleans as well
...
%TODO Write about filterezés \subsubsection{Filterezés}


\subsubsection{Fokális mûveletek MapReduce alapú feldolgozása}
\subsubsection{Fokális mûveletek Orleans alapú feldolgozása}
%TODO Write here about VirtualRaster - RasterService
