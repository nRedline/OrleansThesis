...
felhasznált \textit{AEGIS} keretrendszert. Az Orleans platform teljesítményének
...
A dolgozat célja egy aktor modellre épülõ keretrendszer, az Orleans keretrendszer
teljesítményének vizsgálata távérzékelt felvételek feldolgozásának területén.
Ehhez szükséges volt a keretrendszer kiterjesztése egy egységes téradat-, illetve 
mûveleti modellel melyet az Eötvös Loránd Tudományegyetem Informatikai Karán jelenleg
is fejlesztés alatt álló AEGIS térinformatikai keretrendszer biztosított.
...
A vizsgált mûveletek bemutatásával átfogó képet kaphatunk a távérzékelt
...
Az eredmények azt mutatták, hogy az Orleans keretrendszer és az alapját képezõ
aktor modell koncepció nem nyújt megfelelõ teljesítményt távérzékelt felvételek
feldolgozásának területén. Az aktorok egymás közti információcseréjére építve 
...
A fokális mûveleteknél javítási lehetõség lett volna az egyes aktorok közti információk
gyorsítótárazása, így az aktorok közti szükséges kommunikációk száma csökkenthetõ lett volna.
...
Összességében tehát elmondható, hogy a szegmentáló és klaszterezõ mûveletek feldolgozása során 
az Orleans keretrendszer vagy gyenge, vagy nem mérhetõ eredményeket mutatott, és mivel
ezek a mûveletek a távérzékelt felvételek numerikus kiértékelésének szerves részeit képezik,
így az Orleans keretrendszer nem alkalmas távérzékelt felvételek feldolgozására.
A dolgozat során kifejlesztett ötletek és megvalósításuk (virtuális raszter, 
virtuális szegmensgyûjtemény) egy késõbbiekben megjelenõ, megfelelõ teljesítményt
nyújtó keretrendszerben azonban ideális kiindulási alapot adhatnak a kutatáshoz.
