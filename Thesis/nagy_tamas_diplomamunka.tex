...
során a Hadoop a feldolgozó szoftvert feltölti minden \textit{node}-ra, így az adatok helyben kerülnek
feldolgozásra (\textit{adatlokalitás}).

\subsection{Térinformatikai alkalmazása}
...
alkalmazására. Ennek megfelelõen megjelentek a keretrendszer térinformatikai kiegészítései is
(\textit{SpatialHadoop}\cite{spatialHadoop}, \textit{Hadoop-GIS}\cite{hadoopGIS}).
...
%TODO Link Service-oriented architecture
