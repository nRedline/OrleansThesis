...
Az \textit{Aktor modell} egy olyan konkurens matematikai modell, melynek alapegységei az "\textit{aktorok}".
Az aktorok egymástól izolált egységek, melyek direkt módon, aszinkron üzeneteken keresztül kommunikálnak egymással. 
...
Az aktorok jellemzõen egy számítási szállal rendelkeznek, az állapotuk enkapszulált, és izolált a többi aktortól. 
...
Az \textit{Orleans} egy - a \textit{Microsoft Research} által fejlesztett - keretrendszer, amely megoldást ad 
...
%TODO This refers to Szolgáltatásorientált architektúra which is presented laters
...
\subsection{Szolgáltatásorientált architektúra}
