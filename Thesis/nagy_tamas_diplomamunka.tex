...
helyezkednek. A dolgozat során az itt implementált mûveletek kerültek felhasználásra.
...
\section{Integrálás az Orleans keretrendszerbe}
Távérzékelt felvételek Orleans rendszeren való feldolgozásához szükség volt egy egységes téradatmodellre,
...
szükség, ezek kerültek integrálásra. Mivel mindkét rendszer a .NET keretrendszerre épül, 
így az integráció is egyszerû volt, csupán az AEGIS által nyújtott komponensek \textit{.NET szerelvények} 
(\textit{assembly}) formájában történõ referálására volt szükség az Orleans projektben.
