...
és paraméterezésétõl, valamint a pixelek intenzitásától, így az input particionálása komplex feladat. 
Még jelentõs méretû átfedés definiálásával is fennáll a lehetõség, hogy a mûveletnek további adatokra van szüksége - 
helytelen paraméterezés vagy homogén kép esetén akár az input kép egészére is. Az Orleans rendszer segítségével
azonban elérhetõvé tehetjük ezeket az adatokat a partíciókat feldolgozó egységeknek - az egyes ötletek és megvalósításuk
ismertetésre kerülnek a vizsgált mûveletek bemutatása után.

\subsection{Szegmentálás}
A regionális mûveletek szemléltetésére leginkább
a régió alapú \textit{szegmentáló algoritmusok} a legalkalmasabbak. Ezen mûveletek széles körben
használatosak a távérzékelt felvételek feldolgozásában, a tematikus osztályozás kulcsfontosságú mûveletei.
...
feltételeknek eleget tevõ szomszédos elemeket összevonják. A \textit{vágás alapú} mûveletek esetén kezdetben a teljes
felvételt egy darab szegmensnek tekintjük, melyet minden iterációs lépésben a kritériumoknak megfelelõen 
több részre bontunk. 
...
(\textit{Sequential Coupling Segmentation}) egy összevonás-alapú 
szegmentáló mûvelet, mely elsõ lépésként $2 \times 2$-es méretû kiinduló cellákra osztja fel az input
...
\begin{center}
$$
{\sum_{i=1}^n(x_i - \bar{x})^2 \over {(n-1)\bar{x}^2}} \leq C_H
$$
\end{center}
...
felülrõl lefelé - balról jobbra haladva megpróbáljuk valamelyik szomszédos szegmenshez csatolni. Ha az összevonás
...
(\textit{ANalysis Of VAriance - Varianciaanalízis}) kritériumok teljesülnek.\cite{sequentialCoupling2}

%TODO Elaborate ANOVA Criteria?
...
%TODO Write about processing Quadtree based segmentation
