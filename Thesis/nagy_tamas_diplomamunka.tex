...
álló térinformatikai keretrendszer, melynek fõ célja térinformaikai algoritmusok, megoldások \textit{kutatás}a és \textit{fejlesztés}e.
...
így az Orleans rendszerbe is beilleszthetõ volt. 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=110mm]{figures/aegis_data_model_extensions.png}
	\caption{Az \textit{AEGIS} adatmodellje
