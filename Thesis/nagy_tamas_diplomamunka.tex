...
különálló projektekként jelennek meg a rendszerben.
...
felhasználhatóak a projektben, ezek implementációját pedig a 
\textit{Grains} komponens tartalmazza.
...
A dolgozat során elkészített prototípus alkalmazás (\textit{OrleansSpectral}) felépítése is hasonló, a fent felsorolt
3 komponens felhasználásán túl rendelkezik még egy \textit{Common} projekttel, amely az egyes komponensek mindegyike
...
%TODO Illustration about partition descriptor?
...
%Hogyan kell létrehozni a master graineket, hogyan lehet az adatok pozícióját feltérképezni
%Osztálydiagram a client, Manager és a transformation grain kapcsolatáról
%Aktivitás diagram a feltérképezésrõl és a partition descriptor frissítésének és propagálásának menetérõl
