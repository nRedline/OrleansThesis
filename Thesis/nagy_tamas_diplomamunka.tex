...
vágások során hozna létre a szegmentáló algoritmus. Például a negyedelõ fa alapú szegmentálás 
esetén egyforma méretû, $2^n$ darabszámú partíció létrehozása szükséges.
...
nem tárolják el az input kép egészére a szegmensinformációt, csupán a saját területüket - valamilyen
módon - érintõ szegmenseket.
...
lényegében a teljes input kép bármelyik pixelét és adatát elérhetik. Ezzel lényegében az algoritmusok
bármilyen módosítás nélkül elosztottan, tetszõleges számú partícióval futtathatók.
...
%TODO Elaborate how does the segment get and update workflow work.
%TODO Write about the problem of the reentrant grains

Mivel a szerviz közvetlenül nem
összekapcsolható más szervizekkel, csupán a feldolgozó Grain-ekkel, így ezek interfésze
kiegészítésre került a megfelelõ lekérdezõ és módosító mûveletekkel, tehát lényegében \textit{proxy}
